...
##### 6) Изменить .env файл, установить localhost в DB_HOST_TEST и 5461 в DB_PORT_TEST (чтобы тесты могли работать с БД)

##### 7) Сделать push или pull_request в main ветку своего репозитория
    --- Запуститься процесс CI/CD ---

##### 8) Образом моего проекта, вы можете воспользоваться командой:
